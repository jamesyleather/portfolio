						...
						<form class="form-signin" id="join" action="join" method="post" name="joinform">
							<div class="form-label-group">
								<input type="text" id="id" name="id" class="form-control" placeholder="id"
									required value="${snsUser.id}" readonly="readonly"> 
							...
							<div class="form-label-group">
								<input type="text" id="name" name="name" class="form-control" placeholder="name" required value="${snsUser.name }">
								<label for="name">name</label>
							</div>
							
							<!-- 문제의 input 부분 -->
							<div class="form-label-group">
								<input type="email" id="email" name="email" class="form-control" placeholder="email" value="${snsUser.email }">
							...
							<input type="button"
								...
								onclick="sns_go_save()" value="Register"> 
